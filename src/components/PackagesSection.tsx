  ...
  full: {
    ...
    packages: [
...

      {
        ...
        tagline: "Express Interior Maintenance & Exterior Gloss",
        price: "$130",
        interior: [
    "High-Power Vacuum: Complete loose debris removal from cabin, trunk, and tight crevices.",
    "Standard Interior Wipe Down: A systematic cleaning of the dashboard, console, and door panels to remove light dust and smudges. (No heavy stain scrubbing)",
    "UV Surface Armor (Prevents Fading & Cracking)",
    "Intricate Detail (Cup Holders, Vents, & Crevices)",
    "Streak-Free Glass & Mirror Restoration",
    "Maintenance Floor Mat Clean: Quick vacuum and surface wipe of rubber and carpet mats",
