...
const addOns = [
  ...
  { icon: Eraser, name: "Hard Wax Upgrade", desc: "Swapping the sealant for a hand-applied Paste Wax for that deep wet look", price: "$45" },
  { icon: GlassWater, name: "Machine Liquid Wax", desc: "Application of a high quailty liquid wax using a DA Polisher with a soft finishing pad. ", price: "$45-65" },
  { icon: Droplet, name: "Stain Removal", desc: "I need to see the type of stain oil, ink, organic and the fabric before I can give a final price", price: "$50 starting price" },
